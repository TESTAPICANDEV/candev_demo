$(function () {
    ...
    //Mobile Phone Number
    $demoMaskedInput.find('.mobile-phone-number').inputmask('(999)-999-9999', { placeholder: '(___)-___-_____' });
    //Phone Number
    $demoMaskedInput.find('.phone-number').inputmask('(999)-999-9999', { placeholder: '(___)-___-_____' });

    //Dollar Money
    $demoMaskedInput.find('.money-dollar').inputmask('99,99 $', { placeholder: '__,__ $' });
    //Euro Money
    $demoMaskedInput.find('.money-euro').inputmask('999999,99 °', { placeholder: '______,__ °' });
    ...
    //Serial Key
    $demoMaskedInput.find('.key').inputmask('***-***', { placeholder: '__-____-__' });
    //===========================================================================================================================================
