    ...
    <div class="fp-box">
        ...
        <div class="card" >
            <div class="body" style="background-image: images/qrcode.PNG;">
                <form autocomplete="off" method="POST" action="delete_ticket.php">
                    <div class="msg">
                        Annuler réservation.
                    </div>
                    ...
                    <button type="submit" class="btn btn-block btn-lg bg-green waves-effect" name="submit">ANNULER LE TICKET</button>
                </form>
            </div>
        </div>
    </div>
