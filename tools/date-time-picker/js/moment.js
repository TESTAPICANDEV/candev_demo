...
(function (global, factory) {
    ...
    var defaultLocaleMonths = 'Janvier_Fevrier_Mars_Avril_Mai_Juin_Juillet_Août_Septembre_Octobre_Novembre_Decembre'.split('_');
    function localeMonths (m) {
        return this._months[m.month()];
    }

    var defaultLocaleMonthsShort = 'Jan_Fev_Mar_Avr_Mai_Jui_Jul_Aoû_Sep_Oct_Nov_Dec'.split('_');
