(function($, moment)
{
	...
	function Plugin(element, options)
	{
		...
		this.params = { date : true, time : true, format : 'YYYY-MM-DD', minDate : null, maxDate : null, currentDate : null, lang : 'en', weekStart : 0, shortTime : false, 'cancelText' : 'Annuler', 'okText' : 'OK' };
								...
								'<div class="dtp-content">' +
									'<div class="dtp-date-view">' +
										'<header class="dtp-header">' +
											...
											'<div class="dtp-close"><a href="javascript:void(0);"><img src="../images/closeDtp.png" class = "dtp-close-img"></a></div>' + 
										'</header>' +
										'<div class="dtp-date hidden">' +
											'<div>' +
												'<div class="left center p10">' +
													'<a href="javascript:void(0);" class="dtp-select-month-before"><img src="../images/leftAr.png" class = "dtp-close-img"></a>' +
												'</div>' +
												'<div class="dtp-actual-month p80">MAR</div>' +
												'<div class="right center p10">' +
													'<a href="javascript:void(0);" class="dtp-select-month-after"><img src="../images/rightAr.png" class = "dtp-close-img"></a>' +
												'</div>' +
											...
											'<div>' +
												'<div class="left center p10">' +
													'<a href="javascript:void(0);" class="dtp-select-year-before"><img src="../images/leftAr.png" class = "dtp-close-img"></a>' +
												'</div>' +
												'<div class="dtp-actual-year p80">2014</div>' +
												'<div class="right center p10">' +
													'<a href="javascript:void(0);" class="dtp-select-year-after"><img src="../images/rightAr.png" class = "dtp-close-img"></a>' +
												'</div>' +
												'<div class="clearfix"></div>' +
											'</div>' +
										'</div>' +
